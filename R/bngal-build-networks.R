...
option_list = list(
  ...
  optparse::make_option(c("-o", "--output"),
                        help = "(Required) Output directory for network graphs and data."),
  ...
  optparse::make_option(c("-n", "--subnetworks"), default = NULL,
                        ...
                        * Default = %default"),
  optparse::make_option(c("-t", "--transformation"), default = NULL,
                        help = "Numeric transformation to apply to input data. Can be one of 'log10'.
                        * Default = %default"),
...
if (is.null(opt$asv_table) | is.null(opt$metadata) | is.null(opt$output)){
...
#if (nchar(transformation) == 0) rm(transformation) # figure out
sign = opt$sign
